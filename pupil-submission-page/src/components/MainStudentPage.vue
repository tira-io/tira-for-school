<template>
    ...
    <v-stepper :items="['Deine Aufgabe', 'Baue Deinen Datensatz', 'Trainiere Deine KI', 'Teste Deine KI']" next-text="Weiter" prev-text="Zur&Uuml;ck" :disabled="stepper_navigation_state" v-model="step" v-if="!is_mobile">
        ...
        <template v-slot:item.4><Stepper_4 :model="model_in_progress"/></template>
    </v-stepper>
    ...
    <v-stepper v-model="step" v-if="is_mobile">
        ...
        <v-stepper-window direction="vertical" v-show="step==0">
          <v-stepper-window-item :value="1">
            ...
            <div class="text-center">
              <v-row><v-col cols="4"/><v-col cols="4"><v-btn @click="step=2" color="blue" class="mt-5" block>Weiter</v-btn></v-col></v-row>
            </div>
        ...
        <v-stepper-window direction="vertical" v-show="step==2">
          <v-stepper-window-item :value="2"><Stepper_2 :klasse_vorfahrt_strasse="klasse_vorfahrt_strasse" :klasse_vorfahrt_gewaehren="klasse_vorfahrt_gewaehren"/></v-stepper-window-item>
        </v-stepper-window>
        ...
        <v-stepper-window direction="vertical" v-show="step==3">
          <v-stepper-window-item :value="2"><Stepper_3 @model-trained="modelTrained" :klasse_vorfahrt_strasse="klasse_vorfahrt_strasse" :klasse_vorfahrt_gewaehren="klasse_vorfahrt_gewaehren"/></v-stepper-window-item>
        </v-stepper-window>
        ...
        <v-stepper-window direction="vertical" v-show="step==2">
          <v-stepper-window-item :value="2"><Stepper_4 :model="model_in_progress"/></v-stepper-window-item>
        </v-stepper-window>
    </v-stepper>
</template> 
